// @ts-check
// `@docusaurus/types` added to `dependencies` in `package.json`
/** @type {import('@docusaurus/types').Config} */
const config = {
  title: 'AI-Native Textbook on Physical AI & Humanoid Robotics',
  tagline: 'Comprehensive coverage of Physical AI principles, embodied intelligence, and humanoid robotics',
